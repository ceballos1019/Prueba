<?php
require_once dirname(__FILE__)."/../controller/LibraryController.php";
?>
<h3><i class="fa fa-list-alt"></i> Control de Librerias</h3>
<div class="table-responsive">
	<table class="custom-table">
		...
		<tbody>
			...
			foreach ($lc->getLibraries() as $library): ?>
			<tr>
				<td><?php echo $library->__GET('code'); ?></td>
				<td><?php echo $library->__GET('name'); ?></td>
				<td><?php echo $library->__GET('address'); ?></td>
				<td><?php echo $library->__GET('phoneNumber'); ?></td>
			</tr>
		<?php endforeach; ?>
	</tbody>
</table>
