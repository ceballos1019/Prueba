...
?>
<h3><i class="fa fa-list-alt"></i> Control de Inventario</h3>
<div class="table-responsive">
	<table class="custom-table">
		...
		<tbody>
			...
			foreach ($pc->getProducts() as $product): ?>
			<tr>
				<td><?php echo $product->__GET('code'); ?></td>
				<td><?php echo $product->__GET('productName'); ?></td>
				<td><?php echo $product->__GET('unitCost'); ?></td>
				<td><?php echo $product->__GET('orderPoint'); ?></td>
				<td><?php echo $product->__GET('totalStocks'); ?></td>
			</tr>
		<?php endforeach; ?>
	</tbody>
</table>
