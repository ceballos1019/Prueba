...
<br>
<a class="float" id="add-user" data-toggle="modal" data-target="#add-user-modal" href="#">
	<i class="glyphicon glyphicon-plus"></i>
</a>
<!-- Modal -->
<div class="modal fade" id="add-user-modal" tabindex="-1" role="dialog" aria-hidden="true" aria-labelledby="myModalLabel">
