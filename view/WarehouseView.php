<?php
require_once dirname(__FILE__)."/../controller/WarehouseController.php";
?>
<h3><i class="fa fa-list-alt"></i> Control de Bodegas</h3>
<div class="table-responsive">
	<table class="custom-table">
		...
		<tbody>
			...
			foreach ($wc->getWarehouses() as $warehouse): ?>
			<tr>
				<td><?php echo $warehouse->__GET('code'); ?></td>
				<td><?php echo $warehouse->__GET('name'); ?></td>
				<td><?php echo $warehouse->__GET('location'); ?></td>
			</tr>
		<?php endforeach; ?>
	</tbody>
</table>
