...
<nav class="navbar navbar-personalizado navbar-static-top" id="navigation-bar" role="navigation">
	<div class="container">
		...
		<div class="collapse navbar-collapse" id="menu">
			<ul class="nav navbar-nav nav-personalizado">
				...
				<li id="control-usuarios">
					<a data-toggle="collapse" data-target=".navbar-collapse.in">
						<span class="icon-users"></span> Usuarios
					</a>
				</li>
				<li class="dropdown">
					<a class="dropdown-toggle" data-toggle="dropdown">
...
<section id="contenido">
	<?php
	//require_once("includes/control_usuarios.php");
	require_once(dirname(__FILE__)."/../view/UserView.php");
	?>
</section>
